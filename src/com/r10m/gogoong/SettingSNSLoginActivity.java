...
public class SettingSNSLoginActivity extends Activity {
	...
	private void logout(){
		if (target.equals("facebook")){
            ...
            Toast.makeText(this, getString(R.string.facebooklogout_setting), Toast.LENGTH_SHORT).show();
        	...
        	twitSaveProperties();
        	Toast.makeText(this, getString(R.string.twitlogout_setting), Toast.LENGTH_SHORT).show();
        }
	}
