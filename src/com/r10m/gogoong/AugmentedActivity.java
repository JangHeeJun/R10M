...
import com.r10m.gogoong.filter.NoneFilter;
...
public class AugmentedActivity extends SensorsActivity implements CvCameraViewListener2,OnClickListener{
...
//	String mPath;
                ...
                case LoaderCallbackInterface.SUCCESS:
					...
					try {
						starryNight=new ImageDetectionFilter(
								AugmentedActivity.this,R.drawable.hadchi1);
					} catch (IOException e) {
						e.printStackTrace();
						break;
					}
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        camScreen = (JavaCameraView)findViewById(R.id.surface1);
...
//        }
        	...
        	if(flag){
            	flag = false;
            	Log.e(TAG, "if  "+flag);
            	Intent intent = new Intent(AugmentedActivity.this,DetailPopUp.class);
            	intent.putExtra("name", "해치");
            	intent.putExtra("detail", "해치입니다.");
            	startActivity(intent);	
            }else{
            	 // Apply the active filters.
                flag = mImageDetectionFilters[mImageDetectionFilterIndex].apply(rgba, rgba);
                Log.e(TAG, "else  "+flag);
            }
