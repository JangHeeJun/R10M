...
public class AroundMapCalloutBasicOverlay  extends NMapCalloutOverlay {
	...
	public AroundMapCalloutBasicOverlay(NMapOverlay itemOverlay, NMapOverlayItem item, Rect itemBounds) {
